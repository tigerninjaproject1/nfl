...
bp1 + geom_boxplot() + ylab("Yards Per Play") + xlab("Offensive Team")
```

```{r}
p2 <- ggplot(ydsGainVTd, aes(SumTDs, SumYdsGain)) + geom_point()
p2
```

```{r}
ggplot(ydsGainVTd, aes(SumTDs, SDYdsGain, group = "_id.GameID")) + geom_point()
ggplot(ydsGainVTd, aes(SumYdsGain, SDYdsGain, group = "_id.GameID")) + geom_point()
```
