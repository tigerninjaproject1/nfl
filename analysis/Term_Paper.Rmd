...
ydsGainTD.tibble <- ydsGainTD$`_id`
...
kable(glimpse(as_tibble(ydsGainTD.tibble)))
kable(glimpse(as_tibble(avgYdsTds.tibble)))
kable(glimpse(as_tibble(sumTdsPenYds.tibble)))
kable(glimpse(as_tibble(sumTdsPerQtr.tibble)))
```
